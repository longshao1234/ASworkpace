package com.like.longshaolib.ui;
...
public class CdBaseDialog extends Dialog {
	...
	protected CdBaseDialog(Context context, int theme) {
		super(context, theme);
		this.context = context;
	}

	protected CdBaseDialog(Context context) {
		this(context, R.style.PromptDialogStyle);
	}

	protected CdBaseDialog(Context context, boolean cancelableOnTouchOutside) {
		this(context);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int marginBorder = DensityUtils.dpTopx(context,30);
		params.width = ScreenUtils.getScreenWidth(context) - marginBorder * 2;
	...
	public static class Builder {
		...
		public Builder(Context context, int theme) {
			dialog = new CdBaseDialog(context, theme);
			this.context = context;
			initData();
		}

		public Builder(Context context) {
			dialog = new CdBaseDialog(context);
			this.context = context;
			initData();
		}
		...
		public Builder setMessage(CharSequence message,OnLinearClickListener listener) {
		...
		public Builder setMessage2(CharSequence message,OnLinearClickListener listener) {
