...
import static com.like.longshaolib.adapter.CdBaseRecyleAdapter.EMPTY_VIEW;
import static com.like.longshaolib.adapter.CdBaseRecyleAdapter.FOOTER_VIEW;
import static com.like.longshaolib.adapter.CdBaseRecyleAdapter.HEADER_VIEW;
import static com.like.longshaolib.adapter.CdBaseRecyleAdapter.LOADING_VIEW;
 ...
 * manipulation of item views within the RecyclerView. CdSimpleClickListener may intercept
 * a touch interaction already in progress even if the CdSimpleClickListener is already handling that
 * gesture stream itself for the purposes of scrolling.
 *
 * @see RecyclerView.OnItemTouchListener
 */
public abstract class CdSimpleClickListener implements RecyclerView.OnItemTouchListener {
    private GestureDetectorCompat mGestureDetector;
    private RecyclerView recyclerView;
    private Set<Integer> childClickViewIds;
    private Set<Integer> longClickViewIds;
    protected CdBaseRecyleAdapter baseQuickAdapter;
    public static String TAG = "CdSimpleClickListener";
    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        ...
        if (recyclerView == null) {
            ...
            this.baseQuickAdapter = (CdBaseRecyleAdapter) recyclerView.getAdapter();
    ...
    private class ItemTouchHelperGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            if (mIsPrepressed && mPressedView != null) {
                ...
                CdBaseViewHolder vh = (CdBaseViewHolder) recyclerView.getChildViewHolder(pressedView);
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (mIsPrepressed && mPressedView != null) {
                CdBaseViewHolder vh = (CdBaseViewHolder) recyclerView.getChildViewHolder(mPressedView);
                if (!isHeaderOrFooterPosition(vh.getLayoutPosition())) {
     ...
     */
    public abstract void onItemClick(CdBaseRecyleAdapter adapter, View view, int position);
     ...
     */
    public abstract void onItemLongClick(CdBaseRecyleAdapter adapter, View view, int position);

    public abstract void onItemChildClick(CdBaseRecyleAdapter adapter, View view, int position);

    public abstract void onItemChildLongClick(CdBaseRecyleAdapter adapter, View view, int position);
